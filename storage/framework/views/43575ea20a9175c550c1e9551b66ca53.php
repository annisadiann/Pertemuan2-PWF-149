            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('export-product')): ?>
                        <a href="<?php echo e(route('product.export')); ?>"
...
<?php endif; ?><?php /**PATH C:\laragon\www\Pertemuan2\resources\views/product/index.blade.php ENDPATH**/ ?>